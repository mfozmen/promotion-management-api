...
- Lesson: writing a rule does not inoculate you against it. The rule was correct, recent, and authored in this branch, and the next test still asserted the comfortable half. What catches this is not knowing the rule but the mechanical habit of breaking the production code to see the test go red.
