...
only through `calculateEffectivePrice`. A second copy inline in a query, a worker or a
...
never does.** `import { calculateEffectivePrice } from '@src/modules/promotion/domain/calculate-effective-price.js'`
